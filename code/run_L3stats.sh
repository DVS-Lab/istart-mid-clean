...
for analysis in ppi_seed-NAcc; do #act; do #ppi_seed-NAcc; do # act nppi-dmn nppi-ecn ppi_seed | type-${type}_run-01
	...
	for INTerm in 4A 4B 4C 4D 4E-VBeta 4F-VBeta 4G-VBeta; do	
